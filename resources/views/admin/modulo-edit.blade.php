...
@section('content')
    <p class="text-center">Editar Modulo</p>

<div class="container">
    <form class="bg-white py-2 px-4 shadow rounded mg-2" action="/admin/modulo/update/{{$modulo->id}}"  method="POST" >
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-12 col-sm-10 col-lg-6 mx-auto">
                <h4 class=" text-center ">Nombre modulo</h4>
                    <hr>
